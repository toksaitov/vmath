...
public class Mat4Test {
    ...
    void givenNaNValues_whenMat4Created_thenThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Mat4(firstMat));
        assertThrows(IllegalArgumentException.class, () -> new Mat4(secondMat));
    }
    ...
    void givenArrayOfInvalidLength_whenMat4Created_thenThrowsException() {
        ...
        assertThrows(IllegalArgumentException.class, () -> new Mat4(mat));
    }
}